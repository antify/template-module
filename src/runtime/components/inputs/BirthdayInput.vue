...
const I18N = {
  ...
  tooltips: {
    notLeapYear: {
      ...
      [Locale.bg]: '29 февруари е наличен само през високосни години. Годината, която се опитвате да изберете, не е високосна.',
      ...
      [Locale.pl]: '29 lutego jest dostępny tylko w latach przestępnych. Rok, który próbujesz wybrać, nie jest rokiem przestępnym.',
      [Locale.ru]: '29 февраля бывает только в високосные годы. Год, который вы пытаетесь выбрать, не является високосным.',
      [Locale.sr]: '29. februar je dostupan samo u prestupnim godinama. Godina koju pokušavate da izaberete nije prestupna godina.',
    ...
    invalidMonth: {
      ...
      [Locale.bg]: 'Избрахте ден (като 30-и или 31-ви), който не съществува в този месец. Моля, изберете друг месец.',
      ...
      [Locale.pl]: 'Wybrano dzień (np. 30. lub 31.), który nie istnieje w tym miesiącu. Wybierz inny miesiąc.',
      [Locale.ru]: 'Вы выбрали день (например, 30-е или 31-е число), которого нет в этом месяце. Пожалуйста, выберите другой месяц.',
      [Locale.sr]: 'Izabrali ste dan (kao što je 30. ili 31.) koji ne postoji u ovom mesecu. Molimo izaberite drugi mesec.',
    ...
    selectDayFirst: {
      ...
      [Locale.bg]: 'За да се уверите, че е въведена валидна дата, моля, първо изберете деня, преди да преминете към месеца.',
      [Locale.cs]: 'Aby bylo zajistěno platné datum, začněte prosím výběrem dne, než přejdete na měsíc.',
      ...
      [Locale.pl]: 'Aby upewnić się, że data jest prawidłowa, zacznij od wyboru dnia przed przejściem do miesiąca.',
      [Locale.ru]: 'Чтобы дата была корректной, пожалуйста, сначала выберите день, прежде чем переходить к месяцу.',
      [Locale.sr]: 'Da biste obezbedili važeći datum, molimo počnite izborom dana pre nego što pređete na mesec.',
    ...
    selectMonthFirst: {
      ...
      [Locale.bg]: 'Първо трябва да изберете месец. Това ни помага да се уверим, че крайната дата е напълно валидна.',
      ...
      [Locale.pl]: 'Najpierw musisz wybrać miesiąc. Pomaga to upewnić się, że ostateczna wybrana data jest w pełni prawidłowa.',
      [Locale.ru]: 'Сначала необходимо выбрать месяц. Это поможет нам убедиться, что итоговая дата абсолютно корректна.',
      [Locale.sr]: 'Prvo morate izabrati mesec. To nam pomaže da se uverimo da je konačni datum koji izaberete potpuno važeći.',
    ...
    futureDate: {
      ...
      [Locale.bg]: 'Датата на раждане не може да бъде в бъдещето.',
      ...
      [Locale.pl]: 'Data urodzenia nie może być w przyszłości.',
      [Locale.ru]: 'Дата рождения не может быть в будущем.',
      [Locale.sr]: 'Datum rođenja ne može biti u budućnosti.',
