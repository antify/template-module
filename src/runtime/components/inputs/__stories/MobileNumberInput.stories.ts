...
const meta: Meta<typeof MobileNumberInput> = {
  title: 'Inputs/Mobile Number Input',
  component: MobileNumberInput,
  parameters: {
    docs: {
      description: {
        component: 'Komponente zur Eingabe einer Handynummer. Übersetzt die Platzhalter (Handynummer, Land, Suche) automatisch basierend auf der übergebenen Sprache (Locale).',
      },
    },
  },
  argTypes: {
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div class="p-6 border border-base-200 rounded-lg bg-base-50">
            <h3 class="mb-3 text-md font-bold text-for-white-bg-font flex items-center gap-2">
              Automatische Platzhalter (Mobil)
            </h3>

            <p class="text-xs text-base-400 mb-4">
              Die Platzhalter für die <b>Handynummer</b>, das Land und die Suche werden automatisch je nach ausgewählter Sprache eingefügt.
            </p>
          ...
          <div class="p-6 border border-base-200 rounded-lg bg-base-50">
            ...
            <MobileNumberInput
              ...
              :locale="selectedLocale"
              placeholder="Eigene Handynummer..."
